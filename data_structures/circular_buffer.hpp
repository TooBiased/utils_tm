...
public:
    ...
    inline const_iterator cbegin() const { return const_iterator(this, _start);}
...
{ _off = _circular->inc(_off); return *this; }

template <class T> template <bool b>
typename circular_buffer<T>::template iterator_base<b>&
circular_buffer<T>::iterator_base<b>::operator--()
{ _off = _circular->dec(_off); return *this; }
...
template <class T> template <bool b>
bool
circular_buffer<T>::iterator_base<b>::operator==(const iterator_base& other) const
